...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/assets/css/reset%20(2).css" />
		...
		<link rel="stylesheet" type="text/css" href="/assets/css/reset%20(2).css" media="screen">
		...
		<div class="columns-container">
			<div class="container" id="columns">
				...
				<div class="breadcrumb clearfix">
					...
					<span class="navigation-pipe">&nbsp;</span>
					<span class="navigation_page">我的愿望单</span>
				</div>
				<!-- ./breadcrumb -->
				<!-- row -->
				<div class="row">
					...
					<div class="center_column" id="center_column" align="center">

						<!-- 收藏宝贝模块-->
							<div class="panel panel-danger">
								<div class="panel-heading">
								<h3 class="panel-title">愿望单</h3>
							</div>
								...
								<div id="myTabContent" class="tab-content category-list">
									<div class="tab-pane active " id="grid-container">
										<div class="category-product">
											<div class="row">
											<#if followProductVOList?? && followProductVOList?size != 0>
		             							<#list followProductVOList as followProductVO>
														...
														<div class="products">
															<div class="product">
																<div class="product-info text-left">
																	...
																	<div class="image">
																		<a href="/publicpage/product?proId=${(followProductVO.proId)!}">
																			<img src="/imgs/property/${(followProductVO.proprImg)!}" alt="" class="hover-image" style="width:200px;height: auto;max-height: 350px;max-width: 200px; min-width:200px ;overflow:hidden; ">
																		</a>
																	</div>
																	<!-- /.image -->
																...
																<!-- /.product-image -->
																	...
																	<div class="description">${(followProductVO.proName)!}</div>
																	<div class="product-price"> <span class="price"> ￥${(followProductVO.proprPromotePrice)!} </span>  </div>
																	<!-- /.product-price -->

																</div>
																<!-- /.product-info -->
																<div class="cart clearfix animate-effect text-left">
																	<div class="action">
																		<ul class="list-unstyled">
																			...
																			<li class="lnk wishlist"> <a title="取消关注" href="javascript:;" onclick="wishlist_delete(${(followProductVO.followProductId)!})" class="ml-5" style="text-decoration:none"> <i class="icon fa fa-heart">取消关注</i>
																				</a> </li>
							...
							<div class="" align="center">
								<div class="m-style M-box" align="center"></div>
							</div>
						</div>
					...
					<footer id="footer">
						...
						<div id="footer-menu-box">
							...
							<p class="text-center">Copyrights &#169; 2019 liuliuShop. All Rights Reserved. Designed by liuliushop</p>
						</div><!-- /#footer-menu-box -->
				</div>
				</footer>
				...
				function wishlist_delete(id){
					if(confirm('确认取消关注？')) window.location.href="/user/user_wishlist_del?followProductId="+id; 
				}
				</script>
