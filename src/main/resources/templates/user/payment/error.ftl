...
<!-- end header -->
	...
	<div class="middle-box text-center animated fadeInDown" style="height:700px;padding-top: 250px;">
	    
		<img src="/assets/images/cha1.jpg" alt="product1">
	    <div style="padding-top: 70px;">
	        <font size="40">订单提交失败</font>
			<div style="font-size: 30px;padding-top: 10px;">
			<a href="/user/user_shopping_cart">点击返回购物车</a>
