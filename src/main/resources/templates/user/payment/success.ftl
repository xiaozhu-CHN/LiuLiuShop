...
<body class="category-page">
 ...
 var arr=new Array();
 arr[0]="/assets/images/dui.gif";
 arr[1]="/assets/images/dui.png";
...
<!-- end header -->
	...
	<div class="middle-box text-center animated" style="height:700px;margin-top: 300px; ">
			
		<img id="obj" src ="/assets/images/dui.gif" style="height: 200px;"/>
			<div >
					<font size="40">支付成功</font> 
			</div>
			<div style="margin-top: 60px;">
					<a href="/"><button class="button" style="margin-right:20px;"><i class="fa fa-home"></i> 回到主页</button></a>
					<a href="/user/selectOrderByUserId"><button class="button"><i class="fa fa-book"></i> 查看订单</button></a>
			</div>
	</div>
<footer id="footer">
     <div class="container">
