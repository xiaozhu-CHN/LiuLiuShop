...
<div class="columns-container">
    <div class="container" id="columns">
        ...
        <h2 class="page-heading">
            <span class="page-heading-title2">修改通知邮箱</span>
        </h2>
        <!-- ../page heading-->
        <div class="page-content" align="center">
            		...
            		<table border="1px" width="400px" height="250px">
										...
										<tr>
												<td>
														邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：<br>
														<input type="email" value="${(user.userEmail)!}" id="userEmail" style="width:300px;" placeholder="请输入邮箱！"/>
												</td>
										</tr>
										<tr>
												<td>
								...
								<table>
									<tr>
											<td>
													<button class="button" onclick="user_email_binding()" ><i class="fa fa-lock"></i> 确认修改</button>
											</td>
									</tr>
								</table>
...
function sendMessage() {
	  ...
	  if(user_email==""||user_email==null){
		...
		　　  //向后台发送处理数据
		   $.ajax({
		        type: "POST",
		        url: "/user/user_email_verification",
		        data: {voContent:user_email},
		        dataType: "text",
	...
	function user_email_binding(){
		var oldEmail = "${(user.userEmail)!}";
		var vo_verification = $("#voVerification").val();
		var vo_content = $("#userEmail").val();
		if(vo_verification!=""&&vo_content!=""&&oldEmail!=vo_content){
			 $.ajax({
			        type: "POST",
			        url: "/user/user_email_binding",
			        data: {voVerification:vo_verification,voContent:vo_content},
			        dataType: "text",
			        success: function(data){
			        	if(data=="success"){
			        		$("#msg").html("修改成功！");
