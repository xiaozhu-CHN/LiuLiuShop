...
<div class="columns-container">
    <div class="container" id="columns">
        ...
        <h2 class="page-heading">
            <span class="page-heading-title2">修改资料</span>
        </h2>
        <!-- ../page heading-->
        <div class="page-content" align="center">
            		...
            		<table border="1px" width="400px" height="250px">
										...
										<p style="color:deeppink" id="msg">${msg!}</P>
										<br>
										<tr>
												<td>
														昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称：<br>
														<input type="text" value="${user.userCall!}" id="userCall" style="width:300px;"/>
												</td>
										</tr>
            				...
            				<tr>
            						<td>
            								性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：
            								<input type="radio" name="userSex"  value="1" <#if user.userSex ?? &&  user.userSex==1>checked="checked"</#if> />男
            										<input type="radio" name="userSex"  value="2"<#if user.userSex ?? &&  user.userSex==2>checked="checked"</#if> />女        
            						</td>
            				</tr>
										<tr>
												<td>
													<form method="POST" enctype="multipart/form-data" action="/user/user_upload_logo">
														头&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;像：
														<input type="file" name="userfile" style="width:300px;" accept=".jpg,.jpeg,.png"/>
								...
								<table>
									<tr>
											<td>
													<a><button class="button" onclick="user_update_button()" ><i class="fa fa-lock"></i> 确认修改</button></a>
											</td>
									</tr>
								</table>
...
var userSexOld = ${user.userSex!};
var userCallOld = "${user.userCall!}";
var userId = ${user.userId!};
function user_update_button(){
	var userCall = $("#userCall").val();
	var userSex =  $('input[name="userSex"]:checked').val();
	if(userCall==userCallOld&&userSex==userSexOld){
		$("#msg").html("信息没有更改");
	}else{
		$.ajax({
	        type: "POST",
	        url: "/user/user_update_change",
	        data: {userCall:userCall,userSex:userSex,userId:userId},
	        dataType: "text",
	        success: function(data){
	        	if(data=="success"){
	        		if(userCall!=userCallOld){
	        			userCallOld=userCall
	        		}
	        		if(userSex!=userSexOld){
	        			userSexOld=userSex;
	        		}
	        		$("#msg").html("修改成功！");
	        	}else{
