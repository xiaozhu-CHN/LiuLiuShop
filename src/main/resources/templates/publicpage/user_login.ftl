...
<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            ...
            <span class="navigation_page">用户登录</span>
        </div>
        <!-- ./breadcrumb -->
        <!-- page heading-->
        <h2 class="page-heading">
            <span class="page-heading-title2">用户登录</span>
        </h2>
        <!-- ../page heading-->
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="box-authentication">
                        ...
                        <label for="emmail_login">账&nbsp;户&nbsp;名：</label>
                        <input id="userName" type="text" class="form-control">
                        <label for="password_login">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：</label>
                        <input id="userPwd" type="password" class="form-control">
                       <button class="button" onclick="user_login_form()"><i class="fa fa-lock"></i> 立即登录</button>
												<a href="/publicpage/user_register"><button class="button" ><i class="fa fa-user"></i> 前往注册</button></a>
                    </div>
                </div>
            </div>
        </div>
...
function user_login_form(){
	...
	$.ajax({
        type: "POST",
        url: "/publicpage/user_login_form",
        data: {userName:user_name,userPwd:user_pwd},
        dataType: "text",
