		...
		<div class="columns-container">
			<div class="container" id="columns">
				...
				<div class="breadcrumb clearfix">
					...
					<span class="navigation_page">商品搜索</span>
				</div>
				<!-- ./breadcrumb -->
				<!-- row -->
				<div class="row">
					...
					<div class="center_column col-xs-12 col-sm-12" id="center_column">
						...
						<div class="category-slider">
							<ul class="owl-carousel owl-style2" data-dots="false" data-loop="true" data-nav="true" data-autoplayTimeout="1000"
							 data-autoplayHoverPause="true" data-items="1">
								<li>
									<img src="/assets/data/mate20.png" alt="category-slider">
								</li>
								<li>
									<img src="/assets/data/p30.png" alt="category-slider">
								</li>
								<li>
									<img src="/assets/data/p301.png" alt="category-slider">
								</li>
							</ul>
						</div>
						<!-- ./category-slider -->
						...
						<div class="subcategories">
							<!-- <ul>
								<li>
									<a href="#">销量<i class="fa fa-arrow-down" aria-hidden="true" title="点击后按销量从高到低"></i></a>
								</li>
								<li>
									<a href="#">评分<i class="fa fa-arrow-down" aria-hidden="true" title="点击后按销量从高到低"></i></a>
								</li>
								<li>
									<a href="#">信誉<i class="fa fa-arrow-down" aria-hidden="true" title="点击后按销量从高到低"></i></a>
								</li>
								<li id="price">
									<div id="price_up">
										<a href="#">价格<i class="fa fa-arrow-down" aria-hidden="true" title="点击后按价格从高到低"></i></a>
									</div>
									<div id="price_down">
										<a href="#">价格<i class="fa fa-arrow-up" aria-hidden="true" title="点击后按价格从低到高"></i></a>
									</div>
								</li>
						...
						<div id="view-product-list" class="view-product-list">
							...
							<ul class="row product-list grid">
								<#if productSearchVOList?size != 0>
									<#list productSearchVOList! as  productSearchVO>
										<li class="col-sx-12 col-sm-4">
											<div class="product-container">
												<div class="left-block">
													<a href="/publicpage/product?proId=${(productSearchVO.proId)!}">
														<img class="img-responsive" alt="product" src="/imgs/property/${(productSearchVO.proprImg)!}" height="366px" width="300px" />
													</a>
													<div class="quick-view">
														<a title="添加到愿望单" class="heart" href="JavaScript:wishlist_add(${(productSearchVO.proId)!});"></a>
													</div>
		
												</div>
												<div class="right-block">
													<h5 class="product-name"><a href="/publicpage/product?proId=${(productSearchVO.proId)!}">${(productSearchVO.proName)!}</a></h5>
													<div class="product-star" id="search_star_${(productSearchVO.proId)!}">
														<script type="text/javascript">
	                                                    	html =""; 
	                                                    	for(var i=0;i<${(productSearchVO.proScore)!};i++){
	                                                    		html += '<i class="fa fa-star"></i>';
	                                                    	}
	                                                    	for(var i=0;i<5-${(productSearchVO.proScore)!};i++){
	                                                    		html += '<i class="fa fa-star-o"></i>';
	                                                    	}
	                                                    	$("#search_star_${(followProductVO.proId)!}").html(html);
	                                                    </script>
													</div>
													<div class="content_price">
														<span class="price product-price">¥${(productSearchVO.proprPromotePrice)!}</span>
														<span class="price old-price">¥${(productSearchVO.proprOriginalPrice)!}</span>
													</div>
													<div class="info-orther">
														<p>商品编号: #${(productSearchVO.proId)!}</p>
													
														<div class="product-desc">
															${(productSearchVO.proSubtitle)!}
														</div>
													</div>
												</div>
											</div>
									...
									<ul class="pagination">
										<li>
											<#if pageInfo.hasPreviousPage ?? && pageInfo.hasPreviousPage>   
									        	<a href="/publicpage/category?proName=${proName}&page=${pageInfo.pageNum-1}" aria-label="Next">
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#price").click(function() {
				if (price == 0) {
					price = 1;
					$("#price_up").css("display", "none");
					$("#price_down").css("display", "block");
				} else {
					price = 0;
					$("#price_up").css("display", "block");
					$("#price_down").css("display", "none");
				}
			})
		})
