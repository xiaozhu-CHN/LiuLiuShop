    ...
    <div class="form form-horizontal">
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input name="sysAdminName" id="sysAdminName" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input name="sysAdminPwd" id="sysAdminPwd" type="password" placeholder="密码" class="input-text size-L">
        </div>
      </div>
     <!--  <div class="row cl">
...
<script>
		$("#submit_admin").click(function(){
			var name=$("#sysAdminName").val();
			var pwd=$("#sysAdminPwd").val();
			 $.ajax({
	             type: "POST",
	             url: "/publicpage/systemadminlogin",
	             data: {sysAdminName:name,sysAdminPwd:pwd},
	             dataType: "text",
